/**
 * CalculadoraEndpointCalculadoraendpointSoapBindingStub.java
 *
...
public class CalculadoraEndpointCalculadoraendpointSoapBindingStub extends org.apache.axis.client.Stub implements org.projectws.webservices.CalculadoraWebService {
    ...
    public CalculadoraEndpointCalculadoraendpointSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public CalculadoraEndpointCalculadoraendpointSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public CalculadoraEndpointCalculadoraendpointSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public double calcular(double x, double y) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://webservices.projectws.org/", "calcular"));
